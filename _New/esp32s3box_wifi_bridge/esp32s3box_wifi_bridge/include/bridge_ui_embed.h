...
.toastify{padding:12px 20px;color:#ff9734;display:inline-block;box-shadow:0 3px 6px -1px rgba(0,0,0,.12),0 10px 36px -4px rgba(77,96,232,.3);background:-webkit-linear-gradient(315deg,#73a5ff,#5477f5);background:linear-gradient(135deg,#73a5ff,#5477f5);position:fixed;opacity:0;transition:all .4s cubic-bezier(.215,.61,.355,1);border-radius:2px;cursor:pointer;text-decoration:none;max-width:calc(50% - 20px);z-index:2147483647}.toastify.on{opacity:1}.toast-close{background:0 0;border:0;color:#fff;cursor:pointer;font-family:inherit;font-size:1em;opacity:.4;padding:0 5px}.toastify-right{right:15px}.toastify-left{left:15px}.toastify-top{top:-150px}.toastify-bottom{bottom:-150px}.toastify-rounded{border-radius:25px}.toastify-avatar{width:1.5em;height:1.5em;margin:-7px 5px;border-radius:2px}.toastify-center{margin-left:auto;margin-right:auto;left:0;right:0;max-width:fit-content;max-width:-moz-fit-content}@media only screen and (max-width:360px){.toastify-left,.toastify-right{margin-left:auto;margin-right:auto;left:0;right:0;max-width:fit-content}}</style>
    <style>label,summary{font-weight:400;font-size:small}form,h3{margin-bottom:.5rem}.dot_green,.dot_red{height:.8rem;width:.8rem;border-radius:50%;display:inline-block}html{min-height:100%}body{height:100%;margin:0;color:#fff;background-image:linear-gradient(127deg,#001f3f 5%,#0074d9 100%)}h2{margin-top:2rem;font-size:x-large}h3,h4{font-family:Arial,sans-serif;font-size:large}h4{font-size:medium;font-weight:700}button.button-primary{background-color:transparent;color:#ff9734;border-color:#ff9734}button.button-primary:hover{background-color:#ff9734;color:#fff;border-color:#ff9734}button.button-primary:focus{background-color:#003166;color:#fff;border-color:#9a4e0b}input,select{color:#000}.dot_green{background-color:#68b838}.dot_red{background-color:#f63e3e}.small_text{font-size:small}.img_button:hover{cursor:pointer;filter:invert(60%) sepia(100%) saturate(509%) hue-rotate(334deg) brightness(101%) contrast(101%)}.img_button::selection{cursor:pointer;filter:invert(60%) sepia(100%) saturate(509%) hue-rotate(334deg) brightness(101%) contrast(101%)}.txt_button:hover{color:#ff9734;cursor:help}.tooltip{position:relative;display:inline-block}.tooltip .tooltiptext{visibility:hidden;width:fit-content;background-color:#555;color:#fff;text-align:center;padding:5px;border-radius:6px;position:absolute;z-index:1;bottom:125%;left:50%;margin-left:-60px;opacity:0;transition:opacity .3s}.tooltip .tooltiptext::after{content:"";position:absolute;top:100%;left:50%;margin-left:-5px;border-width:5px;border-style:solid;border-color:#555 transparent transparent}.tooltip:hover .tooltiptext{visibility:visible;opacity:1}div.info{background-color:#00316600;line-height:18px;overflow:hidden;padding:12px;margin-bottom:1.1rem}div.note{border-left:solid 4px #ff881a}div.issue{border-left:solid 4px #f63e3e}@supports (-webkit-appearance:none) or (-moz-appearance:none){.checkbox-wrapper-14 input[type=checkbox]{--active:#ff9734;--active-inner:#fff;--focus:0px rgb(255, 169, 88);--border:#ffffff;--border-hover:#ff9734;--background:#fffff;--disabled:#F6F8FF;--disabled-inner:#E1E6F9;-webkit-appearance:none;-moz-appearance:none;height:21px;outline:0;display:inline-block;vertical-align:top;position:relative;cursor:pointer;border:1px solid var(--bc, var(--border));background:var(--b, var(--background));transition:background .3s,border-color .3s,box-shadow .2s}.checkbox-wrapper-14 input[type=checkbox]:after{content:"";display:block;left:0;top:0;position:absolute;transition:transform var(--d-t, 0.3s) var(--d-t-e, ease),opacity var(--d-o, 0.2s)}.checkbox-wrapper-14 input[type=checkbox]:checked{--b:var(--active);--bc:var(--active);--d-o:.3s;--d-t:.6s;--d-t-e:cubic-bezier(.2, .85, .32, 1.2)}.checkbox-wrapper-14 input[type=checkbox]:disabled{--b:var(--disabled);cursor:not-allowed;opacity:.9}.checkbox-wrapper-14 input[type=checkbox]:disabled:checked{--b:var(--disabled-inner);--bc:var(--border)}.checkbox-wrapper-14 input[type=checkbox]:disabled+label{cursor:not-allowed}.checkbox-wrapper-14 input[type=checkbox]:hover:not(:checked):not(:disabled){--bc:var(--border-hover)}.checkbox-wrapper-14 input[type=checkbox]:focus{--bc:var(--active)}.checkbox-wrapper-14 input[type=checkbox]:not(.switch){width:21px;border-radius:7px}.checkbox-wrapper-14 input[type=checkbox]:not(.switch):after{opacity:var(--o, 0);width:5px;height:9px;border:2px solid var(--active-inner);border-top:0;border-left:0;left:7px;top:4px;transform:rotate(var(--r, 20deg))}.checkbox-wrapper-14 input[type=checkbox]:not(.switch):checked{--o:1;--r:43deg}.checkbox-wrapper-14 input[type=checkbox]+label{display:inline-block;vertical-align:middle;cursor:pointer;margin-left:4px}.checkbox-wrapper-14 input[type=checkbox].switch{width:38px;border-radius:5px}.checkbox-wrapper-14 input[type=checkbox].switch:after{left:2px;top:2px;border-radius:20%;width:17px;height:17px;background:var(--ab, var(--border));transform:translateX(var(--x, 0))}.checkbox-wrapper-14 input[type=checkbox].switch:checked{--ab:var(--active-inner);--x:17px}.checkbox-wrapper-14 input[type=checkbox].switch:disabled:not(:checked):after{opacity:.6}}.checkbox-wrapper-14 *{margin-top:.1rem;box-sizing:inherit}.checkbox-wrapper-14 :after,.checkbox-wrapper-14 :before{box-sizing:inherit}</style>
    <script>/*!
 * Toastify js 1.12.0
 * https://github.com/apvarun/toastify-js
 * @license MIT licensed
