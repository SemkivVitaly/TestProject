...
.toastify{padding:12px 20px;color:#ff9734;display:inline-block;box-shadow:0 3px 6px -1px rgba(0,0,0,.12),0 10px 36px -4px rgba(77,96,232,.3);background:-webkit-linear-gradient(315deg,#73a5ff,#5477f5);background:linear-gradient(135deg,#73a5ff,#5477f5);position:fixed;opacity:0;transition:all .4s cubic-bezier(.215,.61,.355,1);border-radius:2px;cursor:pointer;text-decoration:none;max-width:calc(50% - 20px);z-index:2147483647}.toastify.on{opacity:1}.toast-close{background:0 0;border:0;color:#fff;cursor:pointer;font-family:inherit;font-size:1em;opacity:.4;padding:0 5px}.toastify-right{right:15px}.toastify-left{left:15px}.toastify-top{top:-150px}.toastify-bottom{bottom:-150px}.toastify-rounded{border-radius:25px}.toastify-avatar{width:1.5em;height:1.5em;margin:-7px 5px;border-radius:2px}.toastify-center{margin-left:auto;margin-right:auto;left:0;right:0;max-width:fit-content;max-width:-moz-fit-content}@media only screen and (max-width:360px){.toastify-left,.toastify-right{margin-left:auto;margin-right:auto;left:0;right:0;max-width:fit-content}}</style>
    ...
    .bridge-logo{font-size:1.75rem;font-weight:600;color:#fff;letter-spacing:0.12em;text-align:center;margin:1.2rem 0 0.5rem;text-shadow:0 2px 8px rgba(0,0,0,0.35);}
    ...
    img.bridge-logo-img {max-height:56px;filter:drop-shadow(0 4px 6px rgba(0,0,0,0.3));margin:1rem auto;display:block;}
    .row {margin-bottom: 1rem;}
    #read_bytes, #tcp_connected, #udp_connected, #wifi_rssi_dbm, #chip_temp_c {font-size:1.1rem;font-weight:500;padding:8px 0;}
            ...
            <div class="row">
                ...
                <div class="four columns">
                    ...
                    <div style="display: flex" >
                        ...
                        <button type="button" class="img_button icon_btn" style="margin-left:5rem" title="Добавить UDP-клиента" aria-label="Добавить UDP-клиента" onclick="add_new_udp_client()"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" aria-hidden="true"><path fill="#ff9734" d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg></button>
                        <button type="button" class="img_button icon_btn" style="margin-left:0.5rem" title="Сбросить UDP" aria-label="Сбросить UDP" onclick="clear_udp_clients()"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" aria-hidden="true"><path fill="#ff9734" d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></svg></button>
                    </div>
                </div>
            </div>
            <div class="row">
