...
static void handleParamsPage() {
    String html = F(
        ...
        "document.getElementById('k1').innerHTML=j.SERVO1_REVERSED_known?'<span class=ok>✓</span>':'—'; document.getElementById('k2').innerHTML=j.SERVO3_TRIM_known?'<span class=ok>✓</span>':'—'; document.getElementById('k3').innerHTML=j.SERVO4_TRIM_known?'<span class=ok>✓</span>':'—'; "
